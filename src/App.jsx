...
import { Settings as SettingsIcon, Play, Square, Activity, Terminal, MessageSquare, Plus, Save, CheckSquare, Clock, Globe, User, Cpu, Smartphone, ChevronRight, Check, BookOpen, Trash2, X, Minus, ArrowDownToLine, Puzzle } from 'lucide-react';
...
const I18N = {
  en: {
    ...
    tutorial: "Tutorial", skills: "Custom Skills", clearChat: "Clear History", taskSaved: "Saved", taskBanner: "Autonomous mode scans every 30s.",
  ...
  vi: {
    ...
    tutorial: "Hướng dẫn", skills: "Skill cộng đồng", clearChat: "Xóa lịch sử", taskSaved: "Đã lưu", taskBanner: "AI quét danh sách mỗi 30s.",
